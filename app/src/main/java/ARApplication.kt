...
import com.zaker.android.sapeh.app.main.easysharedpreferences.EasySharedPreferenceConfig.Companion.initDefault
...
class ARApplication : LocalizationApplication() {
    ...
    override fun onCreate() {
        ...
        initDefault(
            EasySharedPreferenceConfig.Builder()
                .inputFileName("easy_preference")
                .inputMode(MODE_PRIVATE)
                .build()
        )
    }
