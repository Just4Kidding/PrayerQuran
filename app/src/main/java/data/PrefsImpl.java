	...
	public void migrateSettings() {
		...
		switch (color) {
			...
			case 8:
				...
				break;
			case 9:
				colorKey = AppConstants.THEME_GREEN;
				break;
			case 10:
				colorKey = AppConstants.THEME_GREY;
				break;
			case 11:
				colorKey = AppConstants.THEME_INDIGO;
				break;
			case 12:
				colorKey = AppConstants.THEME_LIGHT_BLUE;
				break;
			case 13:
				colorKey = AppConstants.THEME_LIGHT_GREEN;
				break;
			case 14:
				colorKey = AppConstants.THEME_LIME;
				break;
			case 0:
			case 15:
