...
import com.zaker.android.sapeh.app.main.finestwebview.enums.ProgressBarPosition
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onDownloadStart
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onLoadResource
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageCommitVisible
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageFinished
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageStarted
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onProgressChanged
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onReceivedTitle
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.onReceivedTouchIconUrl
import com.zaker.android.sapeh.app.main.finestwebview.listeners.BroadCastManager.Companion.unregister
import com.zaker.android.sapeh.app.main.finestwebview.utils.BitmapUtil.getColoredBitmap
import com.zaker.android.sapeh.app.main.finestwebview.utils.BitmapUtil.getGradientBitmap
import com.zaker.android.sapeh.app.main.finestwebview.utils.ColorUtil.disableColor
import com.zaker.android.sapeh.app.main.finestwebview.utils.DisplayUtil.getHeight
import com.zaker.android.sapeh.app.main.finestwebview.utils.DisplayUtil.getStatusBarHeight
import com.zaker.android.sapeh.app.main.finestwebview.utils.DisplayUtil.getWidth
import com.zaker.android.sapeh.app.main.finestwebview.utils.TypefaceUtil
import com.zaker.android.sapeh.app.main.finestwebview.utils.UnitConverter.dpToPx
import com.zaker.android.sapeh.app.main.finestwebview.utils.UrlParser.getHost
...
class FinestWebViewActivity : LocalizationActivity(), AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    protected var fileRepository: FileRepository? = null
    protected var recordView: RecordView? = null
    protected var recordButton: RecordButton? = null
    ...
    protected fun initializeOptions() {
        ...
        val selectableItemBackgroundBorderless = if (VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP)
            typedArray.getResourceId(6, 0) else R.drawable.selector_light_theme
        typedArray.recycle()
       ...
       swipeRefreshColor = if (finestWebView.swipeRefreshColor != null) finestWebView.swipeRefreshColor!! else colorAccent
        ...
        dividerHeight = if (finestWebView.dividerHeight != null) finestWebView.dividerHeight!! else resources.getDimension(
        ...
        progressBarHeight = if (finestWebView.progressBarHeight != null) finestWebView.progressBarHeight!! else resources.getDimension(
        ...
        urlSize = if (finestWebView.urlSize != null) finestWebView.urlSize!! else resources.getDimension(
            R.dimen.defaultUrlSize)
        ...
        menuDropShadowSize = if (finestWebView.menuDropShadowSize != null) finestWebView.menuDropShadowSize!! else resources.getDimension(
        ...
        menuTextSize = if (finestWebView.menuTextSize != null) finestWebView.menuTextSize!! else resources.getDimension(
        ...
        menuTextPaddingLeft = if (finestWebView.menuTextPaddingLeft != null) finestWebView.menuTextPaddingLeft!! else if (rtl) resources.getDimension(
            R.dimen.defaultMenuTextPaddingRight) else resources.getDimension(R.dimen.defaultMenuTextPaddingLeft)
        menuTextPaddingRight = if (finestWebView.menuTextPaddingRight != null) finestWebView.menuTextPaddingRight!! else if (rtl) resources.getDimension(
            R.dimen.defaultMenuTextPaddingLeft) else resources.getDimension(R.dimen.defaultMenuTextPaddingRight)
        ...
        animationCloseEnter = if (finestWebView.animationCloseEnter != null) finestWebView.animationCloseEnter!! else R.anim.shrink_enter
        animationCloseExit = if (finestWebView.animationCloseExit != null) finestWebView.animationCloseExit!! else R.anim.shrink_exit
    ...
    protected fun bindViews() {
        ...
        recordView = findViewById<View>(R.id.record_view) as RecordView
    ...
    protected fun initializeViews() {
        ...
        run { // TextViews
            ...
            urlTv!!.typeface = TypefaceUtil[this, urlFont!!]
    ...
    private lateinit var presenter: MainContract.UserActionsListener
    internal lateinit var start: MediaPlayer
    internal lateinit var finished: MediaPlayer
    internal lateinit var error: MediaPlayer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = ARApplication.injector.provideMainPresenter(applicationContext)
        bindViews()
        layoutViews()
        initializeViews()

        start = MediaPlayer.create(this, R.raw.record_start)
        finished = MediaPlayer.create(this, R.raw.record_finished)
        error = MediaPlayer.create(this, R.raw.record_error)
        ...
        recordView!!.setSlideToCancelTextColor(resources.getColor(R.color.gray_light))

        //change slide To Cancel Arrow Color
        recordView!!.setSlideToCancelArrowColor(resources.getColor(R.color.gray_light))

        //change Counter Time (Chronometer) color
        recordView!!.setCounterTimeColor(resources.getColor(R.color.gray_dark))
        ...
        recordView!!.setOnRecordListener(object : OnRecordListener {
            ...
            override fun onFinish(recordTime: Long) {
                ...
                MaterialToast(context)
                    .setMessage(resources.getString(R.string.recordtoast) + time)
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQ_CODE_REC_AUDIO_AND_WRITE_EXTERNAL && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED && grantResults[2] == PackageManager.PERMISSION_GRANTED) {
            //Start or stop recording
            startRecordingService()
            presenter.pauseUnpauseRecording(applicationContext)
        } else if (requestCode == REQ_CODE_RECORD_AUDIO && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            if (checkStoragePermission2()) {
                startRecordingService()
            }
        } else if (requestCode == REQ_CODE_WRITE_EXTERNAL_STORAGE && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
            if (checkRecordPermission2()) {
                startRecordingService()
            }
        } else if (requestCode == REQ_CODE_READ_EXTERNAL_STORAGE_IMPORT && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
            startFileSelector()
        } else if (requestCode == REQ_CODE_READ_EXTERNAL_STORAGE_PLAYBACK && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
            presenter.startPlayback()
        } else if (requestCode == REQ_CODE_WRITE_EXTERNAL_STORAGE && grantResults.isNotEmpty() && (grantResults[0] == PackageManager.PERMISSION_DENIED
    ...
    private fun startRecordingService() {
        try {
            val path: String = fileRepository!!.provideRecordFile().absolutePath
