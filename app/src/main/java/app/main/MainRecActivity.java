...
import static com.zaker.android.sapeh.ColorMap.primaryColorRes;
...
import com.zaker.android.sapeh.app.DecodeService;
import com.zaker.android.sapeh.app.DecodeServiceListener;
...
import com.zaker.android.sapeh.app.moverecords.MoveRecordsActivity;
import com.zaker.android.sapeh.app.records.RecordsActivity;
import com.zaker.android.sapeh.app.settings.SettingsActivity;
import com.zaker.android.sapeh.app.widget.RecordingWaveformView;
import com.zaker.android.sapeh.app.widget.WaveformViewNew;
...
//	TODO: Add Noise gate
	...
	private LightTextView txtProgress;
	private LightTextView txtDuration;
	private LightTextView txtZeroTime;
	private LightTextView txtName;
	private LightTextView txtRecordInfo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnRecord.setTextColor(getResources().getColor(primaryColorRes));
		btnRecordingStop = findViewById(R.id.btn_record_stop);
		new ClickShrinkEffect(btnRecordingStop);
		btnRecordingStop.setTextColor(getResources().getColor(primaryColorRes));
		...
		playProgress.setOnRubberSeekBarChangeListener(new RubberSeekBar.OnRubberSeekBarChangeListener() {
			@Override
			public void onProgressChanged(@NonNull RubberSeekBar seekBar, int progress, boolean fromUser) {
				if (fromUser){
			...
			@Override
			public void onStartTrackingTouch(@NonNull RubberSeekBar seekBar) {
				presenter.disablePlaybackProgressListener();
			}

			@Override
			public void onStopTrackingTouch(@NonNull RubberSeekBar seekBar) {
