package com.zaker.android.sapeh.app.main.foltingtoast;
...
public class FloatingToast implements FloatingToastStyle{
     ...
     */
    public static final int LENGTH_TOO_LONG = 1750;
     ...
     */
    public static final int FADE_DURATION_TOO_LONG = 1500;
     ...
     */
    public static final int DISTANCE_LONG = 60;
     ...
     *
     * @param activity The activity to use.  Usually your {@link Activity} object.
     * @param text     The text to show.  Can be formatted text.
     * @param duration Duration of the toast to be shown in milliseconds(int).
     *                 Either user-defined int or predefined constant duration
     *                 Available options - {@link #LENGTH_LONG},
    ...
    public FloatingToastStyle setGravity(int gravity) {
        ...
        switch (gravity) {
            ...
            default:
                Objects.requireNonNull(this.dialog.getWindow()).setGravity(gravity);
                break;
        }
        return this;
    }
    ...
    public FloatingToastStyle setShadowLayer(float shadowRadius, float shadowDx, float shadowDy, int shadowColor) {
        if(shadowRadius > 28) shadowRadius = 28;
    ...
    private void initToast(String messageText, final int duration) {
        ...
        layoutParams = Objects.requireNonNull(dialog.getWindow()).getAttributes();
    ...
    private void onStartDialog() {
        final View decorView = Objects.requireNonNull(this.dialog.getWindow())
                .getDecorView();
