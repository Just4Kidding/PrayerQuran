package com.zaker.android.sapeh.app.main.steppertouch
...
class StepperTouch : FrameLayout, OnStepCallback {
    ...
    private fun setStepperSize(view: StepperCounter) {
        view.layoutParams = LayoutParams(newHeight, newHeight, Gravity.CENTER)
    ...
    private fun createTextView(text: String, gravity: Int, @ColorRes color: Int): TextView {
        ...
        val paramsTextView = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, gravity)
