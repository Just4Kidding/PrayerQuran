...
public class CookieBar {
    ...
    final static class Params {
        ...
        public int animationInTop = R.anim.slide_in_left;
        public int animationInBottom = R.anim.slide_in_right;
        public int animationOutTop = R.anim.slide_out_left;
        public int animationOutBottom = R.anim.slide_out_right;
