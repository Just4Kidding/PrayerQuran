package com.zaker.android.sapeh.app.main.bubble;
...
import com.zaker.android.sapeh.app.main.bubble.typeface.IIcon;
import com.zaker.android.sapeh.app.main.bubble.typeface.ITypeface;
import com.zaker.android.sapeh.app.main.bubble.utils.FontUtil;
...
@SuppressWarnings("unused")
    ...
    public class BubbleLayout extends LinearLayout {
        ...
        public static final String TAG = BubbleLayout.class.getSimpleName();
        ...
        public BubbleLayout(Context context, AttributeSet attrs) {
            ...
            @SuppressLint("CustomViewStyleable") TypedArray attrsArray =
                    context.obtainStyledAttributes(attrs, R.styleable.BubbleLayoutAttrs, 0, 0);
        ...
        private TextView setupTextView() {
            ...
            if (getContext().getString(R.string.lang).equals("ar")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/yad.ttf")); //we can pass null in first arg
            }
            if (getContext().getString(R.string.lang).equals("zh")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/korea.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("cs")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("nl")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("en")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("fr")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("de")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("in")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("it")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ja")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/korea.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ko")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/korea.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("fa")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/yad.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("pl")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("pt")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ro")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ru")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/russi.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("es")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("th")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ms")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("hi")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("bn")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ur")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/yad.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("sv")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("sq")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("az")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("bs")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("bg")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/russi.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("ha")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("no")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("so")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            if (getContext().getString(R.string.lang).equals("sw")) {
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
            }
            else if (getContext().getString(R.string.lang).equals("tr"))
                textView.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/eng.ttf"));
        ...
        private void initAttributesArray(TypedArray attrsArray) {
            ...
            mDefaultBackgroundColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_defaultColor,
                            mDefaultBackgroundColor);
            mFocusBackgroundColor = attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_focusColor,
                    mFocusBackgroundColor);
            mDisabledBackgroundColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_disabledColor,
                            mDisabledBackgroundColor);

            mEnabled = attrsArray.getBoolean(R.styleable.BubbleLayoutAttrs_android_enabled, true);

            mDisabledTextColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_disabledTextColor,
                            mDisabledTextColor);
            mDisabledBorderColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_disabledBorderColor,
                            mDisabledBorderColor);
            mDefaultTextColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_textColor, mDefaultTextColor);
            // if default color is set then the icon's color is the same (the default for icon's color)
            mDefaultIconColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_iconColor, mDefaultTextColor);

            mDefaultTextSize =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_textSize,
                            mDefaultTextSize);
            mDefaultTextSize =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_android_textSize,
                            mDefaultTextSize);

            mDefaultTextGravity =
                    attrsArray.getInt(R.styleable.BubbleLayoutAttrs_fb_textGravity, mDefaultTextGravity);

            mBorderColor =
                    attrsArray.getColor(R.styleable.BubbleLayoutAttrs_fb_borderColor, mBorderColor);
            mBorderWidth =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_borderWidth,
                            mBorderWidth);

            // Handle radius for button.
            mRadius =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_radius, mRadius);

            mRadiusTopLeft =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_radiusTopLeft,
                            mRadius);
            mRadiusTopRight =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_radiusTopRight,
                            mRadius);
            mRadiusBottomLeft =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_radiusBottomLeft,
                            mRadius);
            mRadiusBottomRight =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_radiusBottomRight,
                            mRadius);

            mFontIconSize =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_fontIconSize,
                            mFontIconSize);

            mIconPaddingLeft =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_iconPaddingLeft,
                            mIconPaddingLeft);
            mIconPaddingRight =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_iconPaddingRight,
                            mIconPaddingRight);
            mIconPaddingTop =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_iconPaddingTop,
                            mIconPaddingTop);
            mIconPaddingBottom =
                    (int) attrsArray.getDimension(R.styleable.BubbleLayoutAttrs_fb_iconPaddingBottom,
                            mIconPaddingBottom);

            mTextAllCaps =
                    attrsArray.getBoolean(R.styleable.BubbleLayoutAttrs_fb_textAllCaps, false);
            mTextAllCaps =
                    attrsArray.getBoolean(R.styleable.BubbleLayoutAttrs_android_textAllCaps, false);

            mGhost = attrsArray.getBoolean(R.styleable.BubbleLayoutAttrs_fb_ghost, mGhost);
            //mUseSystemFont = attrsArray.getBoolean(R.styleable.MaterialFancyButtonAttrs_fb_useSystemFont,
            //    mUseSystemFont);

            String text = attrsArray.getString(R.styleable.BubbleLayoutAttrs_fb_text);

            if (text == null) { //no mfb_text attribute
                text = attrsArray.getString(R.styleable.BubbleLayoutAttrs_android_text);
            }

            mIconPosition =
                    attrsArray.getInt(R.styleable.BubbleLayoutAttrs_fb_iconPosition, mIconPosition);

            String fontIcon =
                    attrsArray.getString(R.styleable.BubbleLayoutAttrs_fb_fontIconResource);

            String iconFontFamily = attrsArray.getString(R.styleable.BubbleLayoutAttrs_fb_iconFont);
            String textFontFamily = attrsArray.getString(R.styleable.BubbleLayoutAttrs_fb_textFont);

            try {
                mIconResource = attrsArray.getDrawable(R.styleable.BubbleLayoutAttrs_fb_iconResource);
            } catch (Exception e) {
                mIconResource = null;
            }

            mIcon = attrsArray.getString(R.styleable.BubbleLayoutAttrs_fb_icon);
