...
import com.zaker.android.sapeh.app.main.bubble.utils.GenericsUtil;
        ...
        if (!INIT_DONE) {
            ...
            for (String fontsClassPath : fonts) {
                try {
                    ...
                    Log.d(BubbleLayout.TAG, "Typeface = " + typeface.getAuthor());
                } catch (Exception e) {
                    Log.e(BubbleLayout.TAG, "Can't init: " + fontsClassPath);
                }
            }
            Log.d(BubbleLayout.TAG, "Total font = " + FONTS.size());
            INIT_DONE = true;
        }
    }
