...
public class Shareable {
    ...
    public static class Builder {
        ...
        public static final int LINKED_IN = 6;
        public static final int VIBER = 7;
        public static final int TUMBLR = 8;
        public static final int SNAPCHAT = 9;
        public static final int SKYPE = 10;
        public static final int TELEGRAM = 11;
        public static final int REDDIT = 12;
    ...
    private String parseType(int type) {
        switch (type) {
            ...
            case Builder.LINKED_IN:
                return "linkedin";
            case Builder.SNAPCHAT:
                return "snapchat";
            case Builder.SKYPE:
                return "skype";
            case Builder.TELEGRAM:
                return "telegram";
            case Builder.REDDIT:
                return "reddit";
            default:
