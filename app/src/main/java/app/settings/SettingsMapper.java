...
//				SettingsMapper.BITRATE_24000,
	...
	public static String positionToColorKey(int position) {
		switch (position) {
			...
			case 9:
				return AppConstants.THEME_GREEN;
			case 10:
				return AppConstants.THEME_GREY;
			case 11:
				return AppConstants.THEME_INDIGO;
			case 12:
				return AppConstants.THEME_LIGHT_BLUE;
			case 13:
				return AppConstants.THEME_LIGHT_GREEN;
			case 14:
				return AppConstants.THEME_LIME;
			default:
