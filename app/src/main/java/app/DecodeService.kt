...
import com.zaker.android.sapeh.AppConstants.DECODE_DURATION
import com.zaker.android.sapeh.AppConstants.PENDING_INTENT_FLAGS
...
import com.zaker.android.sapeh.audio.AudioDecodingListener
...
import com.zaker.android.sapeh.util.isUsingNightModeResources
...
class DecodeService : Service() {
	...
	private fun startNotification() {
		...
		val intent = Intent(applicationContext, MainRecActivity::class.java)
